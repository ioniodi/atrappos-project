...
export function setShowSaveLocationConsent(show) {
    return {
        type: "SHOW_SAVE_LOCATION_CONSENT",
        showSaveLocationConsent: show
    }
}

export function setShowDrawTutorial(show) {
    return {
        type: "SHOW_DRAW_TUTORIAL",
...
export function setFaqShown(shown) {
    return {
        type: "FAQ_SHOWN",
        faqShown: shown
    }
